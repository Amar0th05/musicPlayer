...
const handleSeek = (e) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 flex items-center justify-center p-8 relative overflow-hidden">
      <div className="bg-black/30 backdrop-blur-xl rounded-3xl p-8 w-full max-w-md shadow-2xl border border-white/10 relative z-10">
        <button
...
/>
        ...
        {/* Progress Bar */}
    <div className="mb-8">
        <div className="w-full bg-gray-700 rounded-full h-2 mb-2" onClick={handleSeek}>
  <div 
